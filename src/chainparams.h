 ...
 * TWINS system. There are three: the main network on which people trade goods
...
public:
    ...
    int EMERGENCY_POW_START() const { return nEmergencyPOWstart; }
    int EMERGENCY_POW_END() const { return nEmergencyPOWend; }
